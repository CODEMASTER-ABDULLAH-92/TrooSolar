...
const SolarPanelCalculator = () => {
  ...
  return (
    ...
    <div className=" sm:block hidden min-h-screen bg-[#f5f6ff] px-10 py-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl">Select your appliance and their corresponding load
        and quantity</h1>
        <p className="text-gray-500 mt-2 max-w-2xl text-base">
          A solar panel calculator estimates the number and size of solar panels
          needed based on your energy usage. It helps you design an efficient
          solar system for your homes, businesses, or off-grid setups.
        </p>
      </div>
