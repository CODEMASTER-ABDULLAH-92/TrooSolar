...
//                     <div className="bg-[#ffff00]/10 border-dashed-[5,5] border-2 rounded-lg border-[#E8A91D] py-2 px-2">
//              <p className="text-[#E8A91D]">       Installation will be carried one of our skilled <br />
//              technician , you can choose not to use our installers</p>
...
//                   className={`py-3 rounded-full text-sm transition duration-200 ${
//                     acceptedTerms
//                       ? "bg-[#273e8e] text-white hover:bg-[#1f2f6e]"
...
//                   <button className="border border-[#273e8e] py-4 text-sm rounded-full text-[#273e8e] hover:bg-[#273e8e]/10 transition duration-150">
//                     Try Again
//                   </button>
//                   <Link
//                     to="/homePage"
//                     className="py-4 text-sm text-center rounded-full bg-[#273e8e] text-white hover:bg-[#1f2f6e] transition duration-150"
//                   >
//                     Continue Shopping
//                   </Link>
//                 </div>
